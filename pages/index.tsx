        ...
        <div className="w-full h-screen container mx-auto py-4 z-10">
          ...
          <div>
            <div className="prompt-container py-4 px-2 gap-6 flex inline justify-center">
              <CustomTextInput userInput={experience1} onChange={onUserChangedExperience} rowNumber={2} label="Experience to Mention"/>
              <CustomTextInput userInput={experience2} onChange={onUserChangedExperience2} rowNumber={2} label="Experience to Mention"/>
            </div>
